...
import os
#Greetings , this code  was   developed  by Akshay on 04-10-2024 .   Please  visit  https://github.com/Akshayskadam  for more information.
...
base.title("QR Code Generator By Akshay")
...
label_1 = Label(base, text="SAVE_AS [file path]").place(x=80, y=10)
